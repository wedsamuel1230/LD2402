/*
  Compare LD2402 UART presence with its OT/IO signal on ESP32-S3.

  Wiring: T/TX -> GPIO16, R/RX -> GPIO17, OT/IO -> GPIO4, GND -> board GND.
  GPIO4 is a default only; check the specific ESP32-S3 board pinout.
*/

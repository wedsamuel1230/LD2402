/*
  HLK-LD2402 web dashboard for Raspberry Pi Pico W.

  Put the real network values in this sketch locally. Never commit them.
  The dashboard is served by the Pico W at port 80 and refreshes once per
  second. It shows raw/filtered distance, UART presence, OT/IO presence, and
  UART data freshness.

  Wiring: T/TX -> GP1, R/RX -> GP0, OT/IO -> GP2, GND -> Pico W GND.
*/

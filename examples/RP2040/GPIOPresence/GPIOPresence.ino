/*
  HLK-LD2402 GPIO-only presence example for Raspberry Pi Pico W.
  ...
  Wiring:
    LD2402 J2 pin 2 OT/IO -> Pico W GP2.
    LD2402 J2 pin 3 GND -> Pico W GND.
...
constexpr uint8_t SENSOR_IO_PIN = 2;  // Pico W GP2
